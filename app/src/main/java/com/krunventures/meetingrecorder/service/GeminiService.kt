...
[넘버링 규칙 — 반드시 아래 위계를 따를 것]
1 대주제
  1.1 중주제
    · 세부사항
      · 상세내용
- numbering 뒤 요약 내용에 ** (볼드 마크) 절대 사용하지 말 것
...
[작성 가이드라인]
1 완결성: 회의에서 언급된 모든 수치, 업체명, 전략, 리스크 및 결정 사항을 빠짐없이 포함할 것.
2 구조화: 안건별로 논의 내용을 분류할 것.
3 간결성: 명사형 종결이나 '~함', '~임' 등의 간결한 문체를 사용할 것.
4 안건별 결론은 별도로 쓰지 말 것. 논의 내용에 자연스럽게 포함.
5 Action Item: 담당자, 기한, 구체적인 실행 과제를 명확히 추출할 것.
6 중요: 주제 하부에 화자별로 정리하지 말 것. 반드시 내용 중심으로 요약할 것.
...
[작성 가이드라인]
1 완결성: 회의에서 언급된 모든 수치, 업체명, 전략, 리스크 및 결정 사항을 빠짐없이 포함할 것.
2 구조화: 시간 흐름에 따라 논의를 분류하고, 논의 전환 포인트를 ↓ 기호로 명시할 것.
3 간결성: 명사형 종결이나 '~함', '~임' 등의 간결한 문체를 사용할 것.
4 Action Item: 담당자, 기한, 구체적인 실행 과제를 명확히 추출할 것.
...
[작성 가이드라인]
1 완결성: 강의에서 언급된 모든 수치, 데이터, 핵심 개념을 빠짐없이 포함할 것.
2 구조화: 주요 내용을 위계에 따라 분류할 것.
3 간결성: 명사형 종결이나 '~함', '~임' 등의 간결한 문체를 사용할 것.
